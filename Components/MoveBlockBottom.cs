...
namespace Celeste.Mod.DzhakeHelper.Components;

internal class MoveBlockBottomComponent : Component
{
    public new CustomMoveBlock Entity => base.Entity as CustomMoveBlock;
    ...
    public override void Added(Entity entity)
    {
        ...
        if (entity is not CustomMoveBlock moveBlock) return;

        CustomMoveBlock block = entity as CustomMoveBlock;

        // add button
        MTexture buttonTexture = GFX.Game[$"{block.Texture}button"];
