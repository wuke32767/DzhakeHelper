...
{
    [CustomEntity("DzhakeHelper/CossetteRefill")]
    public class CossetteRefill : Entity
    {
        ...
        public CossetteRefill(EntityData data, Vector2 offset)
            : base(data.Position + offset)
        {
            ...
            string str = "objects/DzhakeHelper/cossetteRefill/";
