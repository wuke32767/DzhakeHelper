...
[CustomEntity("DzhakeHelper/CossetteZipMover")]
[TrackedAs(typeof(CassetteBlock), true)]
public class CossetteZipMover : CossetteBlock
{
    public class PathRenderer : Entity
    {
        ...
        private readonly CossetteZipMover zipMover;
        ...
        public PathRenderer(CossetteZipMover zipMover, Vector2[] nodes)
        {
    ...
    public CossetteZipMover(EntityData data,Vector2 offset, EntityID id)
        : base(data,offset)
    {
        ...
        cog = GFX.Game["objects/DzhakeHelper/cossetteZipMover/cog"];
        cogPressed = GFX.Game["objects/DzhakeHelper/cossetteZipMover/cogPressed"];
        cogWhite = GFX.Game["objects/DzhakeHelper/cossetteZipMover/cogWhite"];
    }
