...
{
    [CustomEntity("DzhakeHelper/PufferRefill")]
    public class PufferRefill : Entity
    {
        ...
        public PufferRefill(EntityData data, Vector2 offset)
            : base(data.Position + offset)
        {
            ...
            string str = "objects/DzhakeHelper/pufferRefill/";
        ...
        private void OnPlayer(Player player)
        {
            if (useAnyway || player.Dashes < 1 || (player.Stamina < 20f && staminaBased))
            {
                ...
                DzhakeHelperModule.Session.HasPufferDash = true;
