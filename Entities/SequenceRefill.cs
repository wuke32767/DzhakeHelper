...
{
    [CustomEntity("DzhakeHelper/SequenceRefill")]
    public class SequenceRefill : Entity
    {
        ...
        public SequenceRefill(EntityData data, Vector2 offset)
            : base(data.Position + offset)
        {
            ...
            string str = "objects/DzhakeHelper/sequenceRefill/";
