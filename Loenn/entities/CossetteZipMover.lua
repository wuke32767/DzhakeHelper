...
cossetteZipMover.name = "DzhakeHelper/CossetteZipMover"
cossetteZipMover.minimumSize = {16, 16}
cossetteZipMover.nodeLimits = {1, -1}
cossetteZipMover.nodeVisibility = "never"
cossetteZipMover.fieldInformation = {
    index = {
        options = colorNames,
        editable = false,
        fieldType = "integer"
...
cossetteZipMover.placements = {}
for i = 1, 4 do
    cossetteZipMover.placements[i] = {
        name = string.format("cossette_zipMover_%s", i - 1),
        data = {
            index = i - 1,
            width = 16,
            height = 16,
...
function cossetteZipMover.sprite(room, entity)
    local sprites = {}
    ...
    local frame = "objects/DzhakeHelper/cossetteZipMover/solid"
    local depth = -10
    ...
    for _, node in ipairs(nodes) do
        ...
        local nodeCogSprite = drawableSprite.fromTexture("objects/DzhakeHelper/cossetteZipMover/cog")
...
function cossetteZipMover.selection(room, entity)
    local x, y = entity.x or 0, entity.y or 0
